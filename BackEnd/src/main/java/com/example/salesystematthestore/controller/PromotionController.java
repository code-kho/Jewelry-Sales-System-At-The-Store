...
public class PromotionController {
    ...
    @Autowired
    public PromotionController(PromotionServiceImp promotionServiceImp) {
        this.promotionServiceImp = promotionServiceImp;
    }

    @PostMapping
    public ResponseEntity<?> createPromotions(@RequestBody PromotionRequest promotionRequest) {
